defmodule Peridiod.Downloader do
  @moduledoc """
  ...
  alias Peridiod.{Downloader, Downloader.RetryConfig, Downloader.TimeoutCalculation}
  require Logger
  ...
  # Example
        ...
        iex> Peridiod.Downloader.start_download("https://httpbin.com/", fun)
        {:ok, #PID<0.111.0>}
        iex> flush()
        :complete
  """
