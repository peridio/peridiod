...
mkdir -p "$PERIDIOD_PACKAGE_DIR/RPMS" "$PERIDIOD_PACKAGE_DIR/SOURCES" "$PERIDIOD_PACKAGE_DIR/SPECS"
...
rpmbuild -vv -ba --define "_topdir $PERIDIOD_PACKAGE_DIR" "$PERIDIOD_PACKAGE_DIR/SPECS/peridiod.spec"
